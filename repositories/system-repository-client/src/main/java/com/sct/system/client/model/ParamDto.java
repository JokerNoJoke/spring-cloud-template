...
public class ParamDto {
  ...
  public ParamDto id(@Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public ParamDto label(@Nullable String label) {
    this.label = label;
    return this;
  }
  ...
  public ParamDto key(@Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public ParamDto value(@Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public ParamDto createdTime(@Nullable Instant createdTime) {
  ...
  public ParamDto updatedTime(@Nullable Instant updatedTime) {
