...
public class LoginLogBasicDto {
  ...
  public LoginLogBasicDto tenantId(@Nullable Long tenantId) {
  ...
  public LoginLogBasicDto username(@Nullable String username) {
  ...
  public LoginLogBasicDto ip(@Nullable String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public LoginLogBasicDto location(@Nullable String location) {
  ...
  public LoginLogBasicDto os(@Nullable String os) {
    this.os = os;
    return this;
  }
  ...
  public LoginLogBasicDto browser(@Nullable String browser) {
  ...
  public LoginLogBasicDto status(@Nullable Integer status) {
    this.status = status;
    return this;
  }
  ...
  public LoginLogBasicDto message(@Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    LoginLogBasicDto loginLogBasicDto = (LoginLogBasicDto) o;
    return Objects.equals(this.id, loginLogBasicDto.id) &&
        Objects.equals(this.tenantId, loginLogBasicDto.tenantId) &&
        Objects.equals(this.username, loginLogBasicDto.username) &&
        Objects.equals(this.ip, loginLogBasicDto.ip) &&
        Objects.equals(this.location, loginLogBasicDto.location) &&
        Objects.equals(this.os, loginLogBasicDto.os) &&
  ...
  public String toString() {
    ...
    sb.append("class LoginLogBasicDto {\n");
