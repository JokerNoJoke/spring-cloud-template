...
public class MenuDto {
  ...
  public MenuDto createdAt(@Nullable Instant createdAt) {
  ...
  public MenuDto updatedAt(@Nullable Instant updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, menuDto.id) &&
        ...
        Objects.equals(this.createdAt, menuDto.createdAt) &&
        Objects.equals(this.createdBy, menuDto.createdBy) &&
        Objects.equals(this.updatedAt, menuDto.updatedAt) &&
        Objects.equals(this.updatedBy, menuDto.updatedBy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, parentId, parent, type, name, icon, path, permission, sortOrder, enabled, createdAt, createdBy, updatedAt, updatedBy);
  }
