...
public class PageResponseDtoUserDto {
  ...
  public PageResponseDtoUserDto content(List<UserDto> content) {
    this.content = content;
    return this;
  }

  public PageResponseDtoUserDto addContentItem(UserDto contentItem) {
  ...
  public PageResponseDtoUserDto totalElements(@Nullable Long totalElements) {
  ...
  public PageResponseDtoUserDto totalPages(@Nullable Integer totalPages) {
  ...
  public boolean equals(Object o) {
    ...
    PageResponseDtoUserDto pageResponseDtoUserDto = (PageResponseDtoUserDto) o;
    return Objects.equals(this.content, pageResponseDtoUserDto.content) &&
        Objects.equals(this.totalElements, pageResponseDtoUserDto.totalElements) &&
        Objects.equals(this.totalPages, pageResponseDtoUserDto.totalPages);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageResponseDtoUserDto {\n");
