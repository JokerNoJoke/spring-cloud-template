...
public class UserDto {
  ...
  public UserDto createdAt(@Nullable Instant createdAt) {
  ...
  public UserDto updatedAt(@Nullable Instant updatedAt) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, tenant, deptId, dept, username, password, nickname, mobile, avatar, enabled, roles, createdAt, createdBy, updatedAt, updatedBy);
  }
